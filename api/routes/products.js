...
const { createProductSchema, updateProductSchema, getProductSchema, queryProductSchema} = require('../schemas/schemas')
...
router.get('/',
validator(queryProductSchema, 'query'),async (req, res) =>{
